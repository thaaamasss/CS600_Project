...
def run_cifar100_experiment():
    ...
    print("Running CIFAR-100 experiment on:", device)

    train_loader, test_loader = load_dataset("cifar100")
    train_dataset = train_loader.dataset

    # ---------------- SGD TRAINING ----------------

    model_sgd = CNNModel(input_channels=3, num_classes=100, input_size=32)
    ...
    save_model(trained_sgd, "cifar100", "learning", "sgd_model.pth")

    # ---------------- ADAM TRAINING ----------------

    model_adam = CNNModel(input_channels=3, num_classes=100, input_size=32)
    ...
    save_model(trained_adam, "cifar100", "learning", "adam_model.pth")

    # ---------------- RMSPROP TRAINING ----------------

    model_rms = CNNModel(input_channels=3, num_classes=100, input_size=32)
    ...
    save_model(trained_rms, "cifar100", "learning", "rmsprop_model.pth")

    # ---------------- SISA TRAINING ----------------

    # model_sisa = CNNModel(input_channels=3, num_classes=100, input_size=32)
    ...
    save_model(trained_sisa, "cifar100", "learning", "sisa_model.pth")
    ...
    evaluate_learning_algorithms(learning_results, "cifar100")
    ...
    save_model(retrained_model, "cifar100", "unlearning", "retraining_model.pth")
    ...
    save_model(finetuned_model, "cifar100", "unlearning", "finetune_model.pth")
    ...
    save_model(influence_model, "cifar100", "unlearning", "influence_model.pth")
    ...
    save_model(sisa_unlearn_model, "cifar100", "unlearning", "sisa_unlearn_model.pth")
    ...
    evaluate_unlearning_algorithms(unlearning_results, "cifar100")
