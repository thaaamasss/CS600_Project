...
def run_fashion_mnist_experiment():
    ...
    print("Running Fashion-MNIST experiment on:", device)
    ...
    save_model(trained_sgd, "fashion_mnist", "learning", "sgd_model.pth")
    ...
    save_model(trained_adam, "fashion_mnist", "learning", "adam_model.pth")
    ...
    save_model(trained_rms, "fashion_mnist", "learning", "rmsprop_model.pth")
    ...
    save_model(trained_sisa, "fashion_mnist", "learning", "sisa_model.pth")
    ...
    evaluate_learning_algorithms(learning_results, "fashion_mnist")
    ...
    indices_to_delete = list(range(10000, 10500))
    ...
    save_model(retrained_model, "fashion_mnist", "unlearning", "retraining_model.pth")
    ...
    save_model(finetuned_model, "fashion_mnist", "unlearning", "finetune_model.pth")
    ...
    save_model(influence_model, "fashion_mnist", "unlearning", "influence_model.pth")
    ...
    save_model(sisa_unlearn_model, "fashion_mnist", "unlearning", "sisa_unlearn_model.pth")
    ...
    evaluate_unlearning_algorithms(unlearning_results, "fashion_mnist")
